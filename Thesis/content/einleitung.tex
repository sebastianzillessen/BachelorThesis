...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.4\textwidth]{teezer/g_noise_no_robustness}
    \includegraphics[width=0.4\textwidth]{teezer/g_noise_robustness_raum}
    \includegraphics[width=0.4\textwidth]{teezer/E_noise_no_robustness}
    \includegraphics[width=0.4\textwidth]{teezer/E_noise_robustness_raum}
...
\item[\autoref{chap:maths} -- \nameref{chap:maths}:] Der theoretische Ansatz aus Kapitel \autoref{chap:maths} wird hier mathematisch umgesetzt und diskutiert. Außerdem werden die Erweiterungen des Algorithmus beschrieben und formal spezifiziert.
...
\item[\autoref{chap:zusfas} -- \nameref{chap:zusfas}] fasst die Ergebnisse der Arbeit zusammen und stellt Anknüpfungspunkte zu weiteren Arbeiten vor.
\end{description}
