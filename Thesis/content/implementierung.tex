...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{architecture/view}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.8\textwidth]{architecture/matrixes}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.5\textwidth]{architecture/vector}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.5\textwidth]{architecture/sequence_example}
